...
print('''
    ...
    rrrrrrrr  nn     nnn  eeeeeee  ttttttttt
    rr    rr  nnn    nnn  eeeeeee     ttt
    rr    rr  nnnn   nnn  ee          ttt
    rrrrrrrr  nnnnnnnnnn  ee          ttt
    rrrr      nnnnnnnnnn  eeeeeee     ttt
    rr rr     nnnnnnnnnn  ee          ttt
    rr  rr    nn  nnnnnn  ee          ttt
    rr   rr   nnn  nnnnn  eeeeeee     ttt
    rr    rr  nnnn  nnnn  eeeeeee     ttt
...
try:
    ...
    class _Coroutine:
# Falso, quindi puoi fare Coroutine[foo, bar, Baz]
# Si potrebbe affermare che il corretto numero di elementi sono nella fetta,
# ma che sembra come overkill, dato che mypy controllerà questo
# In runtime probabilmente non ti importa più.
...
def loop():
	...
	if choice1 == "0": # se si e' scelta la http flood, scrive gli header "statici" per non appesantire i threads
		...
		connection = "Connection: Keep-Alive\r\n" # la keep alive torna sempre utile 
